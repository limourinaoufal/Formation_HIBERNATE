package ma.lndroid.tp.mappings.one.to.many;
...
import ma.lndroid.tp.mappings.one.to.many.dto.Answer;
import ma.lndroid.tp.mappings.one.to.many.dto.Question;
...
public class Main {
	private static final String PATH = "ma/lndroid/tp/mappings/one/to/many/ressource/hibernate.cfg.xml";
